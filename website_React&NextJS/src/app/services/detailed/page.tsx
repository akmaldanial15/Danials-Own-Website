                ...
                <GlowCard key={pkg.id} color="from-purple-500 to-indigo-600">
                  <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6 lg:gap-8 items-stretch w-full">
                    ...
                    <div className="col-span-12 lg:col-span-4 flex flex-col justify-between space-y-4">
                      <div className="space-y-2">
                        <h3 className="text-xl lg:text-2xl font-black text-white tracking-tight">{pkg.name}</h3>
                        <p className="text-zinc-350 text-[12.5px] leading-relaxed">
                          {pkg.description}
                        </p>
                      </div>
                      
                      <div className="flex items-baseline gap-1.5 py-3 border-y border-zinc-900/60 mt-auto">
                        <span className="text-[11px] text-zinc-400 font-bold uppercase tracking-wider">{t("fromText")}</span>
                    ...
                    {/* Middle Section: Scope & Features (Columns 5-8) */}
                    <div className="col-span-12 lg:col-span-5 flex flex-col justify-center space-y-3 lg:border-l lg:border-zinc-800/40 lg:pl-6">
                      ...
                      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2.5 text-[12.5px] text-zinc-200">
                        {deliverables.map((feature, i) => (
                          <li key={i} className="flex items-start gap-2">
                            ...
                            <span className="leading-tight text-zinc-250">{feature}</span>
                          </li>
                        ))}
                      </ul>
                    </div>

                    {/* Right Section: Development Specs & CTA Button (Columns 9-12) */}
                    <div className="col-span-12 lg:col-span-3 flex flex-col justify-between space-y-4 lg:border-l lg:border-zinc-800/40 lg:pl-6">
                          ...
                          <div className="grid grid-cols-2 gap-1.5">
                            {structured.specs.map((spec, i) => (
                              <div key={i} className="p-2 rounded-xl bg-zinc-950/40 border border-zinc-900/60 flex flex-col justify-center min-h-[46px]">
                                ...
                                <span className="text-white font-extrabold text-[11.5px] mt-1 leading-tight">
                                  {spec.value}
                                </span>
                              </div>
                            ))}
                      ...
                      <div className="pt-2">
                        <a
                          ...
                          className="inline-flex w-full items-center justify-center px-4 py-3 rounded-xl text-xs font-bold bg-purple-600 hover:bg-purple-500 text-white transition-all shadow-md shadow-purple-950/20 active:scale-[0.98]"
                        >
                          {t("btnDiscussDesign")}
                        </a>
                      </div>
