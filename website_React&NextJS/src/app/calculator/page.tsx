                  ...
                  <button
                    ...
                    className={`p-4 rounded-xl text-left border transition-all flex flex-col justify-between h-full group ${
                      selectedPkgId === pkg.id
                        ? "bg-purple-950/20 border-purple-500/50 shadow-[0_0_15px_rgba(59,130,246,0.05)]"
            ...
            <div className="p-6 md:p-8 rounded-2xl bg-zinc-950 border border-zinc-850 shadow-xl relative overflow-hidden">
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-flex w-full items-center justify-center px-4 py-3.5 rounded-xl text-sm font-semibold bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white shadow-lg shadow-purple-950/35 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all"
                >
